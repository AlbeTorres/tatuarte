            ...
            <input type="checkbox" id="menu" className=" hidden nav-input"/>
                {
                    logueado?<ul className='nav-menu nav-transicion'>
                                <li className='p-2 w-full text-center nav-hover efecto'><Link to={"/"} className="w-full block md:text-2xl">Acceder</Link></li>
                                <div className='h-px w-11/12 bg-white'></div>
                                <li className='p-2 w-full text-center nav-hover efecto'><Link to={"/nueva-cuenta"} className="w-full block md:text-2xl">Regístrarse</Link></li>
                            </ul>
